...
One common idea in the different teams was to flip the training on the y axis to account for any turn asymmetry.

The evaluation of model is based on the RMSE on the validation set
