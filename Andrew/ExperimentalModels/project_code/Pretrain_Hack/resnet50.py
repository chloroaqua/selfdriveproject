...
from keras.layers import Conv2D, BatchNormalization, Activation, ZeroPadding2D, MaxPooling2D, AveragePooling2D, Dense, \
    Flatten, GlobalAveragePooling2D, GlobalMaxPooling2D, TimeDistributed
...
def ResNet50(include_top=True, weights='imagenet',
    ...
    if include_top:
        ...
        x = TimeDistributed(Dense(classes, activation='softmax', name='fc1000'))(x)
    else:
        if pooling == 'avg':
