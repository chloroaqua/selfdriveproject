...
model = load_model('../models/3d_test_v2.h5', custom_objects={'rmse': ut.rmse})
...
data, image_copies = ut.get_images("M:\\selfdrive\\SelfDrivingData\\test_out2\\training\\images\\center\\10000.jpg.npy", 10)


pred_value = model.predict(data)
heatmap = visualize_saliency(model, 1, [3], image_copies)
