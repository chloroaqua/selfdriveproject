...
model = load_model('../models/chauffeur_regression_model_100_epoch.h5', custom_objects={'rmse': keras_help.rmse})
...
heatmap, grads = visualize_saliency(model, 18, [0], data)
...
plt.title('Chauffeur Basic Model')
plt.axis('off')


plt.savefig("chauffer_reg.png")
plt.show()
