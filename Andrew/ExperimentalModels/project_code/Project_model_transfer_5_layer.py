...
#model.load_weights("../models/tmp/res50_trans_net_test_5layer_check.hdf5")
...
checkpointer = ModelCheckpoint(filepath="../models/tmp/res50_trans_net_test_5layer_check.hdf5", verbose=1, save_best_only=True)
...
model.save('../models/res50_trans_net_test_5layer_test.h5')
